App.QuestionSeven = React.createClass({
    ...
    render: function () {
        return (
            <div className="question">
                ...
                {['Not at all', 'Several days', 'More than half the days', 'Nearly every day'].map(this.renderOptions.bind(this, 'radio', 'question7'))}
    ...
    nextStep: function (e) {
        ...
        var answer = document.querySelector('input[name="question7"]:checked');
        var data = {
            question7: answer
        }
